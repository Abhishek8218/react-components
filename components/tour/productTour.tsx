...
useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div
        className="fixed z-50 pointer-events-auto bg-white px-2 py-1 shadow-lg rounded-lg  max-w-[30vw] min-w-[30vw] "
        style={{
      ...
      >
        <div
          className={`absolute ${
            currentDirection === 'bottom'
              ...
              ? 'top-[70px]  left-[-90px] -scale-x-100 -rotate-12 '
        ...
        <div className="relative">
          <div className="w-full flex justify-end items-end mb-2">
            <button
              ...
              className=" text-gray-600 hover:text-gray-800 transition  hover:bg-gray-300 hover:rounded-full"
            >
              {/* Cross Icon SVG */}
              <svg
                className="w-5 h-5"
        ...
        <button className='text-sm  text-start  mt-2 hover:font-bold' onClick={hanldeSkipClick} disabled={currentStep === steps.length - 1}>Skip</button>
